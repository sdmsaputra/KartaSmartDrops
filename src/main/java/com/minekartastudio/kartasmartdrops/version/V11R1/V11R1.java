...
public class V11R1 extends V8NmsHandleNameVersion {
    public V11R1(@NotNull final ResourceClient client) throws Exception {
        super(client,  "v1_11_R1",
                ...
                MethodHandles.lookup()
                        .findVirtual(
                                ...
                                "a",
                                MethodType.methodType(String.class, Class.forName("net.minecraft.server.v1_11_R1.ItemStack"))
                        )
        );
    }
}
