package com.minekartastudio.kartasmartdrops.version.V9R1;
...
public class V9R1 extends V8NmsHandleNameVersion {
    public V9R1(@NotNull final ResourceClient client) throws Exception {
        super(client,  "v1_9_R1",
                ...
                MethodHandles.lookup()
                        .findVirtual(
                                ...
                                "f_",
                                MethodType.methodType(String.class, Class.forName("net.minecraft.server.v1_9_R1.ItemStack"))
                        )
        );
    }
}
