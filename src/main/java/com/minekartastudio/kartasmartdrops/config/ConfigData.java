...
import static com.minekartastudio.kartasmartdrops.util.ColorUtil.colorize;
...
public final class ConfigData {
    ...
    public ConfigData(@NotNull final KartaSmartDrops plugin,
    ...
    public void updateData(@NotNull final FileConfiguration conf) {
        ...
        prefixMessage = colorize(msg.getString("prefix", "&5&lKartaSmartDrops &7> &f"));
        ...
        if (enableCustomCountdowns) {
            ...
            for (String materialName : custom.getKeys(false)) {
                ...
                if (material == null) {
                    Bukkit.getConsoleSender().sendMessage("[KartaSmartDrops] Unknown material: " + materialName);
                    continue;
                }
