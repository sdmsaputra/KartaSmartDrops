package com.minekartastudio.kartasmartdrops.metric;

import com.minekartastudio.kartasmartdrops.KartaSmartDrops;
import com.minekartastudio.kartasmartdrops.util.bstats.ConfigurationValueChart;
import com.minekartastudio.kartasmartdrops.util.bstats.Metrics;
...
public class MetricService {
    ...
    private final KartaSmartDrops instance;

    private final Metrics metrics;

    public MetricService(final KartaSmartDrops instance){
